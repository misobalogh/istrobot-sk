    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        <div class="max-w-2xl">
            <form method="post" action="{{ $actionUrl }}" class="mt-6 space-y-6">
                ...
                @endif
                <div>
                    <x-input-label for="name" :value="__('my_robots_messages.name')" required="true" />
                ...
                <div class="flex flex-row gap-4 wrap">
                    <div class="flex-initial w-full">
                        <x-input-label for="author_first_name" :value="__('my_robots_messages.author_first_name')" required="true" />
                    ...
                    <div class="flex-initial w-full">
                        <x-input-label for="author_last_name" :value="__('my_robots_messages.author_last_name')" required="true" />
                ...
                <div>
                    <x-input-label for="coauthors" :value="__('my_robots_messages.coauthors')" />
                ...
                <div class="flex flex-row gap-4 wrap">
                    <div class="flex-initial w-full">
                        <x-input-label for="processor" :value="__('my_robots_messages.processor')" required="true" />
                ...
                <div>
                    <x-input-label for="sensors" :value="__('my_robots_messages.sensors')" />
                ...
                <div class="flex flex-row gap-4 wrap">
                    <div class="flex-initial w-full">
                        <x-input-label for="drive" :value="__('my_robots_messages.drive')" />
                    ...
                    <div class="flex-initial w-full">
                        <x-input-label for="power_supply" :value="__('my_robots_messages.power_supply')" />
                ...
                <div class="flex flex-row gap-4 wrap">
                    <div class="flex-initial w-full">
                        <x-input-label for="programming_language" :value="__('my_robots_messages.programming_language')" required="true" />
                    ...
                    <div class="flex-initial w-full">
                        <x-input-label for="technology_id" :value="__('my_robots_messages.technology')" required="true" />
                ...
                <div>
                    <x-input-label for="interesting_facts" :value="__('my_robots_messages.interesting_facts')" />
                ...
                <div>
                    <x-input-label for="description" :value="__('my_robots_messages.description')" />
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p x-data="{ show: true }" x-show="show" x-transition
                        ...
                        class="text-sm text-gray-600 dark:text-gray-400">{{ __('my_robots_messages.saved') }}</p>
                    @endif
                </div>
            </form>
        </div>
